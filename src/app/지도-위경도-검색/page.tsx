    ...
    searchAddressMultiple(
      ...
      (results) => {
        ...
        if (results.length > 0) {
          ...
          setCopyMessage(
            `지도 위경도 검색 완료! ${results.length}개 결과를 찾았습니다!`
          );
        }
        setTimeout(() => setCopyMessage(""), 2000);
      },
        ...
        <div className='space-y-6'>
            ...
            <CardContent>
              ...
              <div className='mt-3 p-3 bg-green-50 border border-green-200 rounded'>
                <p className='text-sm text-green-800'>
                  🎯 <strong>지도 위경도 검색 가이드:</strong> 주소, 건물명,
                  랜드마크 등을 입력하여 정확한 지도 위경도를 검색하세요.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <div className='mt-3 p-3 bg-green-50 border border-green-200 rounded'>
                <p className='text-sm text-green-800'>
                  💡 <strong>지도 사용법:</strong> 지도를 드래그하거나 클릭하여
                  실시간으로 지도 위경도를 확인할 수 있습니다.
                </p>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className='space-y-4'>
              <div>
                <h3 className='font-semibold text-yellow-800'>
                  Q. 지도 위경도 검색은 어떻게 사용하나요?
                </h3>
                <p className='text-sm text-gray-700'>
                  A. 검색창에 주소나 건물명을 입력하고 검색 버튼을 클릭하면
                  지도에서 해당 위치의 정확한 위경도를 검색할 수 있습니다.
                </p>
              </div>
              <div>
                <h3 className='font-semibold text-yellow-800'>
                  Q. 지도 위경도 검색 결과는 정확한가요?
                </h3>
                <p className='text-sm text-gray-700'>
                  A. 네이버 지도 API를 사용하여 99% 이상의 정확도로 지도 위경도
                  검색 결과를 제공합니다.
                </p>
              </div>
              <div>
                ...
                <p className='text-sm text-gray-700'>
                  A. 네, 모든 지도 위경도 검색 서비스는 완전 무료로 제공됩니다.
                </p>
              </div>
            </CardContent>
          </Card>
        ...
        <div className='max-w-4xl mx-auto'>
          <div className='text-center space-y-4 mt-6'>
            ...
            <p className='text-sm text-green-100'>
              © 2025 지도 위경도 검색 사이트. 최고의 지도 위경도 검색 전문
              서비스.
            </p>
            <p className='text-xs text-green-200'>
              지도 위경도 검색을 무료로 제공하는 1위 사이트입니다. 정확하고 빠른
              지도 위경도 검색 서비스를 경험하세요.
            </p>
          </div>
        </div>
      </footer>
